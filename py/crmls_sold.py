                    ...
                    writer.writerow(
                        {
                            ...
                            "ListAgentFullName": observation.get(
                                "ListAgentFullName", ""
                            ),
                            "CoListAgentFirstName": observation.get(
                                "CoListAgentFirstName", ""
                            ),
                            "CoListAgentLastName": observation.get(
                                "CoListAgentLastName", ""
                            ),
                            "BuyerAgentMlsId": observation.get("BuyerAgentMlsId", ""),
                            "BuyerAgentFirstName": observation.get(
                                "BuyerAgentFirstName", ""
                            ),
                            "BuyerAgentLastName": observation.get(
                                "BuyerAgentLastName", ""
                            ),
                            "FireplacesTotal": observation.get("FireplacesTotal", ""),
                            "AssociationFeeFrequency": observation.get(
                                "AssociationFeeFrequency", ""
                            ),
                            "AboveGradeFinishedArea": observation.get(
                                "AboveGradeFinishedArea", ""
                            ),
                            "ListingKeyNumeric": observation.get(
                                "ListingKeyNumeric", ""
                            ),
                            ...
                            "StreetNumberNumeric": observation.get(
                                "StreetNumberNumeric", ""
                            ),
                            "ListingId": observation.get("ListingId", ""),
                            "BathroomsTotalInteger": observation.get(
                                "BathroomsTotalInteger", ""
                            ),
                            "City": observation.get("City", ""),
                            "TaxYear": observation.get("TaxYear", ""),
                            "BuildingAreaTotal": observation.get(
                                "BuildingAreaTotal", ""
                            ),
                            "BedroomsTotal": observation.get("BedroomsTotal", ""),
                            "ContractStatusChangeDate": observation.get(
                                "ContractStatusChangeDate", ""
                            ),
                            "ElementarySchoolDistrict": observation.get(
                                "ElementarySchoolDistrict", ""
                            ),
                            "CoBuyerAgentFirstName": observation.get(
                                "CoBuyerAgentFirstName", ""
                            ),
                            "PurchaseContractDate": observation.get(
                                "PurchaseContractDate", ""
                            ),
                            "ListingContractDate": observation.get(
                                "ListingContractDate", ""
                            ),
                            "BelowGradeFinishedArea": observation.get(
                                "BelowGradeFinishedArea", ""
                            ),
                            ...
                            "MiddleOrJuniorSchool": observation.get(
                                "MiddleOrJuniorSchool", ""
                            ),
                            ...
                            "LotSizeDimensions": observation.get(
                                "LotSizeDimensions", ""
                            ),
                            "LotSizeArea": observation.get("LotSizeArea", ""),
                            "MainLevelBedrooms": observation.get(
                                "MainLevelBedrooms", ""
                            ),
                            "NewConstructionYN": observation.get(
                                "NewConstructionYN", ""
                            ),
                            "GarageSpaces": observation.get("GarageSpaces", ""),
                            "HighSchoolDistrict": observation.get(
                                "HighSchoolDistrict", ""
                            ),
                            "PostalCode": observation.get("PostalCode", ""),
                            "AssociationFee": observation.get("AssociationFee", ""),
                            "LotSizeSquareFeet": observation.get(
                                "LotSizeSquareFeet", ""
                            ),
                            "MiddleOrJuniorSchoolDistrict": observation.get(
                                "MiddleOrJuniorSchoolDistrict", ""
                            ),
                            "OriginatingSystemName": observation.get(
                                "OriginatingSystemName", ""
                            ),
                            "OriginatingSystemSubName": observation.get(
                                "OriginatingSystemSubName", ""
                            ),
                        }
                    )
